...
def _add_parser_list_systems(subparsers: _SubParsersAction):
    ...
    parser.add_argument(
        "-F", "--list-fields", action="store_true", help="list available fields"
    )
    parser.add_argument(
        "-C",
        "--customer",
    ...
    parser.add_argument(
        "--fitted", action="store_true", dest="fitted", help="filter for fittet systems"
    )
    parser.add_argument(
        "--unfitted",
        action="store_false",
...
def _add_parser_list_deployments(subparsers: _SubParsersAction):
    ...
    parser.add_argument(
        "--testing", type=int, metavar="testing", help="filter for testing deployments"
    )
    parser.add_argument(
        "-t",
        "--type",
    ...
    parser.add_argument(
        ...
        type=system,
        metavar="system",
        help="filter for the respective systems",
    )
    parser.add_argument(
        "-f",
        "--fields",
...
def _add_parser_find_systems(subparsers: _SubParsersAction):
    ...
    parser.add_argument("pattern", help="filter for systems of the respective pattern")
    parser.add_argument(
        "house_number",
        nargs="?",
